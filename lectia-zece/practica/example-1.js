...
*/
class Blogger {
  constructor({ email, age, numberOfPosts, topics, proprietateNoua }) {
    this.email = email;
    this.age = age;
    this.numberOfPosts = numberOfPosts;
    this.topics = topics;
  }
  proprietateNoua = "String";
...
//!IMPORTANT - https://medium.com/@Adekola_Olawale/beginners-guide-to-object-oriented-programming-a94601ea2fbd

// class ClasaParinte {
//   hello() {
//     console.log("Hello from ClasaParinte");
//   }
// }

// class ClasaFiu extends ClasaParinte {}

// const parinte = new ClasaParinte();
// const fiu = new ClasaFiu();
